...
<html>
    ...
    <body>
        ...
        <div class="dashboard-main-wrapper">
            ...
            <%@include file="admin/templates/left-sidebar.jsp" %>

            <c:set var="listProductDetails" value="${requestScope['listProductDetails']}" />
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2">Product Detail Dashboard</h3>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="dashboard" class="breadcrumb-link">Dashboard</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Product Detail Dashboard</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                <c:forEach var="productDetail" items="${listProductDetails}">
                                                    <tr>
                                                        <td>
                                                            <div class="m-r-10"><img src="templates/img${productDetail.getImage()}" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>${productDetail.getID()}</td>
                                                        <td>${productDetail.getProID()}</td>
