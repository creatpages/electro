                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <c:forEach var="orderDetail" items="${order.getOrderDetailList()}">
                                                                ${orderDetail.getProductDetatilName()} (${orderDetail.getQuantity()}x)
                                                            </c:forEach>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="badge-dot badge-brand mr-1"></span>Canceled
                                                            </c:if>
                                                            <c:if test="${order.getStatus()==2}">
                                                            <span class="badge-dot badge-brand mr-1"></span>Preparing
                                                            </c:if>
                                                            <c:if test="${order.getStatus()==3}">
                                                            <span class="badge-dot badge-success mr-1"></span>Delivering
                                                            </c:if>
                                                            <c:if test="${order.getStatus()==3}">
